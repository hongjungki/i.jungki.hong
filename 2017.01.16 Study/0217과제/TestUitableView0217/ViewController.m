    ...
    switch (indexPath.section) {
        case 0:
            [cell setDataWithImagename:[NSString stringWithFormat:@"%ld.png", indexPath.row+1]
             ...
             break;
        case 1:
            [cell setDataWithImagename:[NSString stringWithFormat:@"%ld.png", indexPath.row+3]
            ...
            break;
        case 2:
            [cell setDataWithImagename:[NSString stringWithFormat:@"%ld.png", indexPath.row+4]
        ...
        case 3:
            [cell setDataWithImagename:[NSString stringWithFormat:@"%ld.png", indexPath.row+6]
