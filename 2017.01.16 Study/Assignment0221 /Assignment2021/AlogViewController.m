...
@implementation AlogViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    UIImageView *newImage = [[UIImageView alloc] initWithFrame:CGRectMake(30 , 80,150, 150)];
    //[newImage setCenter:CGPointMake(self.view.center.x, self.view.center.y/3)];
    [newImage setImage:[UIImage imageNamed:@"IMG_0727.jpg"]];
